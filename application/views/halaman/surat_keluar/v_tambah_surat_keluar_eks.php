  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="#">Surat Keluar Eksternal</a></div>
        <div class="breadcrumb-item">Tambah Surat Keluar Eksternal</div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <form method="POST" action="<?php echo site_url('transaksi_surat/aksi_tambah_surat_keluar_eks') ?>" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="no_surat" class="form-control" value="<?php echo $no_surat.'/'.$instalasi->kode_surat.'/'.$bulan.'/'.$tahun; ?>">
                    </div>

                    <div class="form-group">
                      <label><i class="fas fa-quote-left"></i> Tujuan</label>
                      <input type="text" name="tujuan" class="form-control" value="<?php echo $tujuan?>" required>
                    </div>

                    <div class="form-group">
                      <label><i class="fas fa-file-alt"></i> Asal Surat</label>
                      <input type="hidden" name="" class="form-control" value="<?php echo $user->id_user?>">
                      <input type="hidden" name="jenis" class="form-control" value="Eksternal Keluar">
                    ...
                    <div class="row">
                      ...
                      <div class="col-6">
                        <div class="form-group">
                          <a href="<?php echo site_url('transaksi_surat/surat_keluar_eksternal') ?>" class="btn btn-light btn-block"><i class="fas fa-times"></i> Batal</a>
                        </div>
                      </div>
                    </div>
                  </div>
