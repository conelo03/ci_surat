...
<div class="main-content">
  ...
  <section class="section">
    <div class="section-header">
      <h1><i class="fa fa-users fa-sm"></i> Edit Instruksi</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
        <div class="breadcrumb-item"><a href="#">Kelola Disposisi</a></div>
        <div class="breadcrumb-item">Edit Instruksi</div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <form method="POST" action="<?php echo site_url('disposisi/aksi_edit_instruksi') ?>" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="id_instruksi" class="form-control" value="<?php echo $instruksi->id_instruksi?>">
                          <input type="text" name="instruksi" class="form-control" value="<?php echo $instruksi->instruksi ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <select name="terusan" class="form-control selectric">
                            ...
                            <option value="<?php echo $j->id_jabatan?>" <?php if ($j->id_jabatan == $instruksi->terusan){ echo 'selected';}?>><?php echo $j->id_jabatan?> - <?php echo $j->jabatan?></option>
                            <?php endforeach; ?>
                          </select>
                        </div> 
                      </div>
