...
<div class="main-content">
  ...
  <section class="section">
    <div class="section-header">
      <h1><i class="fa fa-file fa-sm"></i> Laporan Surat Masuk Eksternal</h1>
      ...
      <div class="card">
        <div class="card-body">
            <div class="row">
              ...
              <div class="col-6">
                <form method="POST" action="<?php echo site_url('Disposisi/laporan_eks_sort') ?>" enctype="multipart/form-data">
              ...
              <div class="col-6">
                <form method="POST" action="<?php echo site_url('Disposisi/cetak_laporan_eks') ?>" enctype="multipart/form-data">
                <div class="form-group">
                  <label><i class="fas fa-calendar"></i> Tanggal Mulai</label>
                  <input type="date" name="tgl_mulai" value="" class="form-control" required>
                </div>
